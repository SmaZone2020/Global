            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-3 items-center mb-4">
                <div className="bg-cream-dark/60 p-3">
                  ...
                  <p className="text-ink text-sm">{asset.chineseExpression}</p>
                </div>
                <ArrowRight className="w-5 h-5 text-gold hidden md:block" />
                <div className="bg-cream-dark/60 p-3">
                  <p className="text-xs text-ink/40 mb-1">海外表达</p>
                  <p className="text-ink text-sm">{asset.overseasExpression}</p>
                </div>
              </div>
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-xs text-ink/40 w-10 text-right">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {content.prohibitedTranslations.map((item, i) => (
            <div
              key={i}
              className="p-4 border border-unverified/30 bg-unverified/5"
            >
